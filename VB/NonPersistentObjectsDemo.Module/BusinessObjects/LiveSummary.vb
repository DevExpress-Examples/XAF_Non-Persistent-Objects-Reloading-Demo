...
'INSTANT VB NOTE: The variable id was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub SetKey(ByVal id_Conflict As Guid)
...
'INSTANT VB NOTE: The variable name was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub SetName(ByVal name_Conflict As String)
...
'INSTANT VB NOTE: The variable status was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub SetStatus(ByVal status_Conflict As OrderStatus)
			Me.Status = status_Conflict
		End Sub
		...
		Public Property Period() As Integer
			...
			End Set
		End Property
'INSTANT VB NOTE: The variable period was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub SetPeriod(ByVal period_Conflict As Integer)
			Me.Period = period_Conflict
		End Sub
