...
Namespace NonPersistentObjectsDemo.Win
    ...
    Public Partial Class NonPersistentObjectsDemoWindowsFormsApplication
...
#End Region
        ...
        Private Sub NonPersistentObjectsDemoWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub NonPersistentObjectsDemoWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
