...
Namespace NonPersReload.Blazor.Server
    ...
    Public Class NonPersReloadBlazorApplication
        Inherits BlazorApplication

        Public Sub New()
            ApplicationName = "NonPersReload"
            CheckCompatibilityType = DevExpress.ExpressApp.CheckCompatibilityType.DatabaseSchema
            DatabaseVersionMismatch += AddressOf NonPersReloadBlazorApplication_DatabaseVersionMismatch
        End Sub
...
#End If
        ...
        Private Sub NonPersReloadBlazorApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
