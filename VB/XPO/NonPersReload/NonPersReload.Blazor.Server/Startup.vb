...
Imports NonPersReload.Blazor.Server.Services
    ...
    Public Class Startup
        ...
        Public Sub ConfigureServices(ByVal services As IServiceCollection)
            ...
            services.AddXaf(Configuration, Function(builder)
                builder.UseApplication(Of NonPersReloadBlazorApplication)()
                builder.Modules.Add(Of NonPersReload.Module.NonPersReloadModule)().Add(Of NonPersReloadBlazorModule)()
