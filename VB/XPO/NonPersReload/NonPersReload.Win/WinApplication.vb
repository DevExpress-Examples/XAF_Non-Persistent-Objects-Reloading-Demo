...
Namespace NonPersReload.Win
    ...
    Public Class NonPersReloadWindowsFormsApplication
        ...
        Public Sub New()
            ...
            DatabaseVersionMismatch += AddressOf NonPersReloadWindowsFormsApplication_DatabaseVersionMismatch
            CustomizeLanguagesList += AddressOf NonPersReloadWindowsFormsApplication_CustomizeLanguagesList
        End Sub

        Private Sub NonPersReloadWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub NonPersReloadWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
