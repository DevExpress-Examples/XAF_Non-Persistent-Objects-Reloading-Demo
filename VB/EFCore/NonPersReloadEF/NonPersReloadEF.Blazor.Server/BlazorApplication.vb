...
Namespace NonPersReloadEF.Blazor.Server
    ...
    Public Class NonPersReloadEFBlazorApplication
        Inherits BlazorApplication

        Public Sub New()
            ApplicationName = "NonPersReloadEF"
            CheckCompatibilityType = DevExpress.ExpressApp.CheckCompatibilityType.DatabaseSchema
            DatabaseVersionMismatch += AddressOf NonPersReloadEFBlazorApplication_DatabaseVersionMismatch
        End Sub
...
#End If
        ...
        Private Sub NonPersReloadEFBlazorApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
