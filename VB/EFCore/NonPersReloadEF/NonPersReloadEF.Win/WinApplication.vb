...
Imports NonPersReloadEF.Module
Imports NonPersReloadEF.Module.BusinessObjects

Namespace NonPersReloadEF.Win

    ' For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Win.WinApplication._members
    Public Class NonPersReloadEFWindowsFormsApplication
        ...
        Public Sub New()
            ...
            DatabaseVersionMismatch += AddressOf NonPersReloadEFWindowsFormsApplication_DatabaseVersionMismatch
            CustomizeLanguagesList += AddressOf NonPersReloadEFWindowsFormsApplication_CustomizeLanguagesList
        End Sub

        Private Sub NonPersReloadEFWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub NonPersReloadEFWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
