...
namespace NonPersistentObjectsDemo.Module.BusinessObjects {
    ...
    static class LiveSummaryPresetStorage {
        ...
        static LiveSummaryPresetStorage() {
            ...
            presets.Add(Guid.NewGuid(), new LiveSummaryPreset() { Name = "To deliver", Status = OrderStatus.Active, Period = 100 });
            presets.Add(Guid.NewGuid(), new LiveSummaryPreset() { Name = "Delayed this week", Status = OrderStatus.Delayed, Period = 7 });
        }
