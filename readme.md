...
# How to refresh Non-Persistent Objects and reload nested Persistent Pbjects

## Scenario

It is often required to cancel changes made to [Non\-Persistent Objects](https://docs.devexpress.com/eXpressAppFramework/116516/concepts/business-model-design/non-persistent-objects) in a view. When a Non-Persistent object has links to Persistent Objects, it is often required to reload these likned objects too. However, the built-in Refresh action has no effect in these scenarios by default.
